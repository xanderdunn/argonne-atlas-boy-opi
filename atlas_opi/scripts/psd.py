...
# subprocess.Popen(["export PATH=/usr/local/oag/apps/bin/linux-x86:$PATH;", plotpath + " " + filepath + " " + str(welch1) + " " + str(welch2)], stdin=subprocess.PIPE, shell=True, cwd=runpath)
